    ...
    <div class="container">
        <header class="section-heading py-4">
            <h3 class="section-title">
                Tất cả sách: ${requestScope.totalProducts} sản phẩm
            </h3>
        </header>
            ...
            <nav class="mt-4">
                <ul class="pagination">
                    ...
                    <li class="page-item ${requestScope.page == 1 ? 'disabled' : ''}">
                        <a class="page-link"
                           href="${pageContext.request.contextPath}/allbook?page=${requestScope.page - 1}">
                            Trang trước
                        </a>
                    </li>
                    ...
                    <c:forEach begin="1" end="${requestScope.totalPages}" var="i">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item">
                                    <a class="page-link"
                                       href="${pageContext.request.contextPath}/allbook?page=${i}">
                                            ${i}
                                    </a>
                                </li>
                            </c:otherwise>
